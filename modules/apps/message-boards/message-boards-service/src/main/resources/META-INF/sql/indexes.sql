...
create index IX_44320A1F on MBBan (uuid_[$COLUMN_LENGTH:75$]);

create index IX_BC735DCF on MBCategory (companyId);
create unique index IX_BD2D8996 on MBCategory (groupId, friendlyURL[$COLUMN_LENGTH:255$], ctCollectionId);
...
create index IX_E264D946 on MBCategory (uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_2C38379C on MBDiscussion (uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_8C785165 on MBMailingList (uuid_[$COLUMN_LENGTH:75$]);

create index IX_51A8D44D on MBMessage (classNameId, classPK);
create index IX_B1432D30 on MBMessage (companyId);
create index IX_99A45BB0 on MBMessage (externalReferenceCode[$COLUMN_LENGTH:75$]);
...
create unique index IX_67245876 on MBMessage (groupId, urlSubject[$COLUMN_LENGTH:255$], ctCollectionId);
...
create index IX_4413C6A7 on MBMessage (uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_AB8919B8 on MBSuspiciousActivity (uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_87BF127A on MBThread (uuid_[$COLUMN_LENGTH:75$]);

create unique index IX_93555EE2 on MBThreadFlag (threadId, userId, ctCollectionId);
create index IX_E23141EE on MBThreadFlag (uuid_[$COLUMN_LENGTH:75$]);