...
public class AssetEntityAnalyticsBatchEngineTaskItemDelegate
	...
	protected void activate() {
		_lazyClassNameIds = _classNameLocalService.getLazyClassNameIds(
			AssetEntityAnalyticsBatchEngineTaskItemDelegate.class.getName(),
			new String[] {
	...
	private Predicate _buildPredicate(
		...
		return predicate.and(
			AssetEntryTable.INSTANCE.classNameId.in(_lazyClassNameIds.get()));
	}
