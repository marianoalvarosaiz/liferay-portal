...
public class JournalArticleFinderImpl
	...
	public static final String FIND_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L =
		JournalArticleFinder.class.getName() +
			".findByC_G_F_C_A_V_T_D_C_S_T_D_R_L";

	/**
	 * @deprecated As of Cavanaugh (7.4.x), replace by {@link #countByKeywords(long, long, List, long, String, Double, String, String, Date, Date, int, Date, Locale)}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use countByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use filterCountByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #filterFindByKeywords(long, long, List, long, String, Double, String, String, Date, Date, int, Date, Locale, int, int, OrderByComparator)}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use filterFindByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use findByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use doCountByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
	protected int doCountByC_G_F_C_A_V_T_D_C_S_T_D_R(
		...
		return doCountByC_G_F_C_A_V_T_D_C_S_T_D_R_L(
			...
			LocaleUtil.getMostRelevantLocale(), andOperator, queryDefinition,
			inlineSQLHelper);
	}
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), use doFindByC_G_F_C_A_V_T_D_C_S_T_D_R_L instead
	 */
	@Deprecated
