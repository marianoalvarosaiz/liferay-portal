...
public class JournalArticleFinderImpl
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #COUNT_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L}
	 */
	@Deprecated
	...
	public static final String COUNT_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L =
		JournalArticleFinder.class.getName() +
			".countByC_G_F_C_A_V_T_D_C_S_T_D_R_L";
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link #FIND_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L}
	 */
	@Deprecated
	...
	public int countByC_G_F_C_A_V_T_D_C_S_T_D_R(
		...
		return doCountByC_G_F_C_A_V_T_D_C_S_T_D_R_L(
			...
			titles, descriptions, contents, ddmStructureKeys, ddmTemplateKeys,
			displayDateGT, displayDateLT, reviewDate,
			LocaleUtil.getSiteDefault(), andOperator, queryDefinition, false);
	}
	...
	protected int doCountByC_G_F_C_A_V_T_D_C_S_T_D_R_L(
		...
		try {
			...
			String sql = _customSQL.get(
				getClass(), COUNT_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L,
				queryDefinition, "JournalArticle");
	...
	protected List<JournalArticle> doFindByC_G_F_C_A_V_T_D_C_S_T_D_R_L(
		...
		try {
			...
			String sql = _customSQL.get(
				getClass(), FIND_BY_C_G_F_C_A_V_T_D_C_S_T_D_R_L,
				queryDefinition, "JournalArticle");
