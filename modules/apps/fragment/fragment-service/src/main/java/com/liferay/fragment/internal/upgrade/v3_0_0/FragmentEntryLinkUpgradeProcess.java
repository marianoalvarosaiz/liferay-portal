		...
		processConcurrently(
			SQLTransformer.transform(
				StringBundler.concat(
					...
					"tempFragmentEntryLink.ctCollectionId from ",
					"FragmentEntryLink tempFragmentEntryLink where ",
					"tempFragmentEntryLink.fragmentEntryLinkId = ",
					"FragmentEntryLink1.originalFragmentEntryLinkId and ",
					"tempFragmentEntryLink.ctCollectionId = ",
					...
					"tempFragmentEntry.ctCollectionId from FragmentEntry ",
					"tempFragmentEntry where tempFragmentEntry.fragmentEntryId ",
					"= FragmentEntryLink1.fragmentEntryId and ",
					"tempFragmentEntry.ctCollectionId = ",
					...
					"tempGroup_.ctCollectionId from Group_ tempGroup_ where ",
					"tempGroup_.groupId = FragmentEntry.groupId and ",
					"tempGroup_.ctCollectionId = ",
