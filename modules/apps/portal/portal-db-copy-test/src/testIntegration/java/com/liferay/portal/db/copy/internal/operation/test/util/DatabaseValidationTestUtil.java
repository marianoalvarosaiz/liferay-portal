...
public class DatabaseValidationTestUtil {
	...
	public static void assertDatabaseCopyIsEqualsToCurrent(String copiedSchema)
		throws Exception {

		_assertSameIndexesStructure(copiedSchema);
		_assertSameTablesStructure(copiedSchema);
	}
