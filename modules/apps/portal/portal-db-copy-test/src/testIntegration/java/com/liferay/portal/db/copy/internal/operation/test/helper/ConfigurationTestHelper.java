...
package com.liferay.portal.db.copy.internal.operation.test.helper;
...
public class ConfigurationTestHelper {
	...
	public void deployConfiguration(String pid, String copySchema)
		throws Exception {
		...
		try (AutoCloseable autoCloseable =
			...
			_createConfiguration(pid, _getConfigurationContent(copySchema));
	...
	private String _getConfigurationContent(String copySchema) {
		return StringBundler.concat(
			"driverClassName=\"", PropsValues.JDBC_DEFAULT_DRIVER_CLASS_NAME,
			"\"", StringPool.NEW_LINE, "url=\"",
			DatabaseTestUtil.getSchemaURL(copySchema), "\"",
			StringPool.NEW_LINE, "userName=\"",
			PropsValues.JDBC_DEFAULT_USERNAME, "\"", StringPool.NEW_LINE,
			"password=\"", PropsValues.JDBC_DEFAULT_PASSWORD, "\"",
			StringPool.NEW_LINE);
	}
