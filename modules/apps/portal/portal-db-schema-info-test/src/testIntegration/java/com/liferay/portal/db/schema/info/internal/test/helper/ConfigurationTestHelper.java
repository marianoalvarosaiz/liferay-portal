...
public class ConfigurationTestHelper {
	...
	public void deployConfiguration(String pid, String dumpPath)
		throws Exception {
		...
		try (AutoCloseable autoCloseable =
			...
			_createConfiguration(pid, _getConfigurationContent(dumpPath));
	...
	private String _getConfigurationContent(String dumpPath) {
		return StringBundler.concat(
			"databaseType=\"mysql\"", StringPool.NEW_LINE, "path=\"", dumpPath,
			"\"", StringPool.NEW_LINE);
	}
