...
public class DBCopyOperation {
	...
	private DataSource _getDataSource(Map<String, Object> properties)
		throws Exception {
	...
	private void _performCopy(Map<String, Object> properties) {
		...
		try {
			DataSource targetDataSource = _getDataSource(properties);

			LiferayDBDuplicator.copyTo(targetDataSource);
