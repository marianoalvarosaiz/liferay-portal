...
package com.liferay.portal.db.schema.info.internal.validation;
 ...
 */
public class DBSchemaDumpValidation {

	public static void validateSchemaDump(String path) throws Exception {
