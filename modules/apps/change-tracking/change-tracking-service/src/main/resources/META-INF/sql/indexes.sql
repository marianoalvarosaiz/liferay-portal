...
create index IX_BB144D93 on CTCollection (externalReferenceCode[$COLUMN_LENGTH:75$]);
create index IX_CCDD86CD on CTCollection (schemaVersionId);
create index IX_17F1DE8A on CTCollection (uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_78FF5E41 on CTEntry (externalReferenceCode[$COLUMN_LENGTH:75$]);
create index IX_2C400B38 on CTEntry (uuid_[$COLUMN_LENGTH:75$]);
