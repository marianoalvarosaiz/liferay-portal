...
<%
PortletPreferences systemPortletPreferences = PrefsPropsUtil.getPreferences(CompanyConstants.SYSTEM);

Function<String, String> preferenceFunction = key -> systemPortletPreferences.getValue(key, PropsUtil.get(key));
%>
