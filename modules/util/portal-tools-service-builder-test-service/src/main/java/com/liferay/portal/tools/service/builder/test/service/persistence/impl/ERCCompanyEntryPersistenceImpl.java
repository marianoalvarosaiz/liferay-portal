...
public class ERCCompanyEntryPersistenceImpl
	...
	private List<ERCCompanyEntry> _findByUuid(
		String uuid, int start, int end,
		OrderByComparator<ERCCompanyEntry> orderByComparator,
	...
	private List<ERCCompanyEntry> _findByUuid_C(
		String uuid, long companyId, int start, int end,
		OrderByComparator<ERCCompanyEntry> orderByComparator,
		boolean useFinderCache, boolean readOnlyCache) {
	...
	private ERCCompanyEntry _findByC_ERC(
			long companyId, String externalReferenceCode, boolean readOnlyCache)
		throws NoSuchERCCompanyEntryException {

		ERCCompanyEntry ercCompanyEntry = _fetchByC_ERC(
	...
	private ERCCompanyEntry _fetchByC_ERC(
		long companyId, String externalReferenceCode, boolean useFinderCache,
	...
	public ERCCompanyEntry removeByC_ERC(
		...
		ERCCompanyEntry ercCompanyEntry = _findByC_ERC(
	...
	private List<ERCCompanyEntry> _findAll(
		int start, int end,
		OrderByComparator<ERCCompanyEntry> orderByComparator,
		boolean useFinderCache, boolean readOnlyCache) {
