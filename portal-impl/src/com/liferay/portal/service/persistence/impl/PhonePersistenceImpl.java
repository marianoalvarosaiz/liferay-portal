...
public class PhonePersistenceImpl
	...
	private List<Phone> _findByUuid(
		String uuid, int start, int end,
		OrderByComparator<Phone> orderByComparator, boolean useFinderCache,
	...
	private List<Phone> _findByUuid_C(
		String uuid, long companyId, int start, int end,
		OrderByComparator<Phone> orderByComparator, boolean useFinderCache,
		boolean readOnlyCache) {
	...
	private List<Phone> _findByCompanyId(
		long companyId, int start, int end,
		OrderByComparator<Phone> orderByComparator, boolean useFinderCache,
		boolean readOnlyCache) {
	...
	private List<Phone> _findByUserId(
		long userId, int start, int end,
		OrderByComparator<Phone> orderByComparator, boolean useFinderCache,
		boolean readOnlyCache) {
	...
	private List<Phone> _findByC_C_C(
		long companyId, long classNameId, long classPK, int start, int end,
		OrderByComparator<Phone> orderByComparator, boolean useFinderCache,
		boolean readOnlyCache) {
	...
	private List<Phone> _findByC_C_C_P(
		long companyId, long classNameId, long classPK, boolean primary,
		int start, int end, OrderByComparator<Phone> orderByComparator,
