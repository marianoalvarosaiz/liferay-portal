...
public class IndexUpdaterUtil {
	...
	public static void updateIndexes(Bundle bundle) throws Exception {
		String indexesSQL = DBResourceUtil.getModuleIndexes(bundle);
		String tablesSQL = DBResourceUtil.getModuleTables(bundle);
	...
	private static void _updatePortalIndexes(DB db, Connection connection)
		...
		db.updateIndexes(
			connection, DBResourceUtil.getPortalTables(),
			DBResourceUtil.getPortalIndexes(), true);
	}
