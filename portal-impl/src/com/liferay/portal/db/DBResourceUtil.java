...
public class DBResourceUtil {
	...
	public static String getModuleIndexes(Bundle bundle) {
		return _getSQLTemplateString(bundle, "indexes.sql");
	}

	public static String getModuleSequences(Bundle bundle) {
		return _getSQLTemplateString(bundle, "sequences.sql");
	}

	public static String getModuleTables(Bundle bundle) {
		return _getSQLTemplateString(bundle, "tables.sql");
	}

	public static String getPortalIndexes() throws IOException {
		return _getPortalResource(
			"com/liferay/portal/tools/sql/dependencies/indexes.sql");
	}

	public static String getPortalTables() throws IOException {
		return _getPortalResource(
